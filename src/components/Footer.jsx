        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12 pb-12">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-cream/80 font-medium">
              <li><Link href="#" className="hover:text-cream hover:underline transition-colors">About</Link></li>
              <li><Link href="#" className="hover:text-cream hover:underline transition-colors">Breeds</Link></li>
              <li><Link href="#" className="hover:text-cream hover:underline transition-colors">Allergy Guide</Link></li>
              <li><Link href="#" className="hover:text-cream hover:underline transition-colors">Product Reviews</Link></li>
              <li><Link href="#" className="hover:text-cream hover:underline transition-colors">Tools</Link></li>
              <li><Link href="#" className="hover:text-cream hover:underline transition-colors">Blog</Link></li>
            </ul>
          </div>

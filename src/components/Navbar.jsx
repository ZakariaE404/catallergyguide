...
const dropdownData = {
  breeds: {
    ...
    items: [
      ...
      { label: 'Balinese Cats', href: '/breeds/balinese-cats' },
      { label: 'Devon Rex', href: '/breeds/devon-rex' },
      { label: 'Sphynx Cats', href: '/breeds/sphynx-cats' },
  ...
  allergyGuide: {
    ...
    items: [
      ...
      { label: 'Allergy Symptoms Guide', href: '/allergy-guide/allergy-symptoms-guide' },
  ...
  productReviews: {
    ...
    items: [
      { label: 'Best Air Purifiers', href: '/product-reviews/best-air-purifiers' },
      { label: 'Best Cat Food', href: '/product-reviews/best-cat-food' },
